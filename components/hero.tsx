      ...
      <div className="container-pad relative grid min-h-[calc(100vh-5rem)] items-center gap-10 py-20 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <h1 className="text-balance text-5xl font-black tracking-tight text-navy sm:text-6xl lg:text-7xl">
            Technology Strategy. AI Transformation. Enterprise Delivery.
          </h1>
          <p className="mt-7 max-w-2xl text-xl leading-9 text-slate-700">
            Helping government agencies and commercial organizations modernize operations through
            Artificial Intelligence, intelligent automation, cloud technologies, and expert technology leadership.
          </p>
        ...
        <div className="relative min-h-[420px]">
          ...
          <div className="absolute left-8 right-8 top-8 rounded-md border border-slate-200 bg-white p-5 shadow-sm">
            <div className="mb-5 flex items-center justify-between">
              <p className="text-sm font-black text-navy">AI Transformation Console</p>
              <span className="rounded-md bg-emerald-50 px-3 py-1 text-xs font-black text-emerald-700">Live</span>
            </div>
            <div className="space-y-3">
              {["Assess enterprise readiness", "Automate priority workflows", "Modernize cloud operations"].map(
                (label, index) => (
