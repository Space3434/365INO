...
export function CtaBanner() {
  return (
    <section className="bg-[#E7E6DF] py-[0.55rem] sm:py-[0.825rem]">
      <div className="mx-auto w-[calc(100%-2.125rem)] sm:w-[min(calc(100%-3rem),57.5rem)] lg:w-full lg:px-16">
        <div className="grid gap-10 lg:grid-cols-[minmax(20rem,calc((100vw-88.75rem)/2+24.5rem))_minmax(0,1fr)] lg:items-center lg:gap-12">
